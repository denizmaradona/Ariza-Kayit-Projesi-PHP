<?php
	...
	if(isset($_POST["kayit_ol"])){ // Kayıt Olunduğunda
    ...
    else if(isset($_POST["giris_yap"])){ // Giriş İçin
        ...
        if ($error){
            ...
            if ($row[@bilgi]=="kullanici girisi basarili"){
                ...
                include 'dbsettings.php'; // İsim Çekilmesi
                $result = mysqli_query($connection,
        ...
        else{ // Sistemde böyle bir e-mail mevcut değil
                    ...
                    <div id="home-slider" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="img/iphone.png" class="img-responsive center-block">
                            </div>
                            <div class="item">
                                <img src="img/nokia-lumia.png" class="img-responsive center-block">
                            </div>
                            <div class="item">
                                <img src="img/asus-zenfone.png" class="img-responsive center-block">
                            </div>
                            <div class="item">
                                <img src="img/samsung-galaxy.png" class="img-responsive center-block">
                            </div>
                        </div>
